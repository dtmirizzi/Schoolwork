...
public class ComplexNumber {
	...
	if(this.i!=0){
	    double temp= (this.r*Math.sqrt(this.r*this.r*this.i*this.i))/2;
	    double temp2= ((-1*this.r)*Math.sqrt(this.r*this.r*this.i*this.i))/2;
		...
		return new ComplexNumber(0, Math.sqrt(this.r*-1));
	    }
	}
